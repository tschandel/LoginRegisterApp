package com.selflearning.app.model;
...
public class User {
	...
	@Size(min = 5, message = "login id should have atleast 5 characters")
	...
	@Size(min = 5, message = "first_name should have atleast 5 characters")
	@Column(name = "first_name", length = 50, nullable = false, unique = false)
	private String firstName;

	@NotEmpty(message = "Last Name can't be empty")
	@Size(min = 5, message = "last_name should have atleast 5 characters")
