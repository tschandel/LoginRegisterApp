package com.selflearning.app.exception;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		ErrorMessage errorMessage = new ErrorMessage("MethodArgumentNotValid Exception ", errors.toString());
	...
	public ResponseEntity<Object> handleConstraintViolation(ConstraintViolationException ex, WebRequest request) {
		ErrorMessage errorMessage = new ErrorMessage("ConstraintViolation Exception ", ex.getMessage());
	...
	protected ResponseEntity<Object> handleHttpRequestMethodNotSupported(HttpRequestMethodNotSupportedException ex,
		...
		ErrorMessage errorMessage = new ErrorMessage("HttpRequestMethodNotSupported Exception - Method Not Allowed ",
				ex.getMessage());
		// System.err.println(errorMessage);
	...
	protected ResponseEntity<Object> handleNoHandlerFoundException(NoHandlerFoundException ex, HttpHeaders headers,
		...
		ErrorMessage errorMessage = new ErrorMessage("NoHandlerFound Exception - No service found for given request ",
				ex.getMessage());
		// System.err.println(errorMessage);
		return new ResponseEntity<>(errorMessage, HttpStatus.NOT_FOUND);
	}
	 ...
	 * , ex.getMessage()); // System.err.println(errorMessage); return new
	 ...
	 * 
	 * ErrorMessage errorMessage = new ErrorMessage("TypeMismatch Exception ",
	 * ex.getMessage()); System.err.println(errorMessage); return new
	 * ResponseEntity<>(errorMessage, HttpStatus.BAD_REQUEST);
	 * 
	 * }
